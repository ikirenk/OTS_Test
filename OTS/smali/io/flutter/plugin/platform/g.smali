...
.field private d:Lm3/k$j;

.field private e:I

.field final f:Lm3/k$h;


# direct methods
.method public constructor <init>(Landroid/app/Activity;Lm3/k;Lio/flutter/plugin/platform/g$d;)V
    .locals 1
    ...
    iput-object v0, p0, Lio/flutter/plugin/platform/g;->f:Lm3/k$h;

    iput-object p1, p0, Lio/flutter/plugin/platform/g;->a:Landroid/app/Activity;

    iput-object p2, p0, Lio/flutter/plugin/platform/g;->b:Lm3/k;

    invoke-virtual {p2, v0}, Lm3/k;->l(Lm3/k$h;)V
...
.method private C(Lm3/k$j;)V
    ...
    new-instance v2, Landroidx/core/view/p3;

    invoke-direct {v2, v0, v1}, Landroidx/core/view/p3;-><init>(Landroid/view/Window;Landroid/view/View;)V
    ...
    iget-object v3, p1, Lm3/k$j;->b:Lm3/k$d;
    ...
    :cond_1
    invoke-virtual {v2, v4}, Landroidx/core/view/p3;->b(Z)V

    goto :goto_0

    :cond_2
    invoke-virtual {v2, v6}, Landroidx/core/view/p3;->b(Z)V

    :cond_3
    :goto_0
    iget-object v3, p1, Lm3/k$j;->a:Ljava/lang/Integer;
    ...
    :cond_4
    iget-object v3, p1, Lm3/k$j;->c:Ljava/lang/Boolean;
    ...
    iget-object v3, p1, Lm3/k$j;->e:Lm3/k$d;
    ...
    :cond_6
    invoke-virtual {v2, v4}, Landroidx/core/view/p3;->a(Z)V

    goto :goto_1

    :cond_7
    invoke-virtual {v2, v6}, Landroidx/core/view/p3;->a(Z)V

    :cond_8
    :goto_1
    iget-object v2, p1, Lm3/k$j;->d:Ljava/lang/Integer;
    ...
    :cond_9
    iget-object v2, p1, Lm3/k$j;->f:Ljava/lang/Integer;
    ...
    :cond_a
    iget-object v2, p1, Lm3/k$j;->g:Ljava/lang/Boolean;
    ...
    :cond_b
    iput-object p1, p0, Lio/flutter/plugin/platform/g;->d:Lm3/k$j;
...
.method static synthetic a(Lio/flutter/plugin/platform/g;Lm3/k$i;)V
    .locals 0

    invoke-direct {p0, p1}, Lio/flutter/plugin/platform/g;->s(Lm3/k$i;)V
...
.method static synthetic c(Lio/flutter/plugin/platform/g;Lm3/k$e;)Ljava/lang/CharSequence;
    .locals 0

    invoke-direct {p0, p1}, Lio/flutter/plugin/platform/g;->r(Lm3/k$e;)Ljava/lang/CharSequence;
...
.method static synthetic g(Lio/flutter/plugin/platform/g;)Lm3/k;
    .locals 0

    iget-object p0, p0, Lio/flutter/plugin/platform/g;->b:Lm3/k;

    return-object p0
.end method

.method static synthetic h(Lio/flutter/plugin/platform/g;Lm3/k$c;)V
    .locals 0

    invoke-direct {p0, p1}, Lio/flutter/plugin/platform/g;->x(Lm3/k$c;)V
...
.method static synthetic j(Lio/flutter/plugin/platform/g;Lm3/k$k;)V
    .locals 0

    invoke-direct {p0, p1}, Lio/flutter/plugin/platform/g;->z(Lm3/k$k;)V
...
.method static synthetic m(Lio/flutter/plugin/platform/g;Lm3/k$j;)V
    .locals 0

    invoke-direct {p0, p1}, Lio/flutter/plugin/platform/g;->C(Lm3/k$j;)V
...
.method private r(Lm3/k$e;)Ljava/lang/CharSequence;
    .locals 6
    ...
    sget-object v2, Lm3/k$e;->f:Lm3/k$e;
    ...
    invoke-static {v0, p1}, La3/b;->g(Ljava/lang/String;Ljava/lang/String;)V
    ...
    invoke-static {v0, v1, p1}, La3/b;->h(Ljava/lang/String;Ljava/lang/String;Ljava/lang/Throwable;)V
...
.method private s(Lm3/k$i;)V
    .locals 1

    sget-object v0, Lm3/k$i;->f:Lm3/k$i;
...
.method private t()V
    ...
    invoke-interface {v0}, Landroidx/activity/t;->j()Landroidx/activity/OnBackPressedDispatcher;
...
.method private x(Lm3/k$c;)V
    ...
    iget-object v2, p1, Lm3/k$c;->b:Ljava/lang/String;

    const/4 v3, 0x0

    iget p1, p1, Lm3/k$c;->a:I
    ...
    iget-object v1, p1, Lm3/k$c;->b:Ljava/lang/String;
...
.method private z(Lm3/k$k;)V
    .locals 1

    sget-object v0, Lm3/k$k;->f:Lm3/k$k;
    ...
    :cond_0
    sget-object v0, Lm3/k$k;->g:Lm3/k$k;
    ...
    :cond_1
    sget-object v0, Lm3/k$k;->h:Lm3/k$k;
    ...
    :cond_2
    sget-object v0, Lm3/k$k;->i:Lm3/k$k;
...
.method public E()V
    ...
    iget-object v0, p0, Lio/flutter/plugin/platform/g;->d:Lm3/k$j;

    if-eqz v0, :cond_0

    invoke-direct {p0, v0}, Lio/flutter/plugin/platform/g;->C(Lm3/k$j;)V
...
.method public q()V
    ...
    iget-object v0, p0, Lio/flutter/plugin/platform/g;->b:Lm3/k;

    const/4 v1, 0x0

    invoke-virtual {v0, v1}, Lm3/k;->l(Lm3/k$h;)V
