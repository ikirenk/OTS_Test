...
.field c:Lio/flutter/embedding/android/y;
...
.method private g(Lio/flutter/embedding/engine/d$b;)Lio/flutter/embedding/engine/d$b;
    ...
    invoke-virtual {v0}, La3/a;->c()Ld3/d;
    ...
    invoke-direct {v1, v0, v2}, Lb3/a$b;-><init>(Ljava/lang/String;Ljava/lang/String;)V
    ...
    :cond_2
    invoke-virtual {p1, v1}, Lio/flutter/embedding/engine/d$b;->i(Lb3/a$b;)Lio/flutter/embedding/engine/d$b;
...
.method private j(Lio/flutter/embedding/android/y;)V
    .locals 2

    iget-object v0, p0, Lio/flutter/embedding/android/g;->a:Lio/flutter/embedding/android/g$c;

    invoke-interface {v0}, Lio/flutter/embedding/android/g$c;->z()Lio/flutter/embedding/android/j0;

    move-result-object v0

    sget-object v1, Lio/flutter/embedding/android/j0;->e:Lio/flutter/embedding/android/j0;
    ...
    invoke-direct {v0, p0, p1}, Lio/flutter/embedding/android/g$b;-><init>(Lio/flutter/embedding/android/g;Lio/flutter/embedding/android/y;)V
...
.method private k()V
    ...
    invoke-virtual {v2}, Lio/flutter/embedding/engine/a;->o()Lm3/j;

    move-result-object v2

    invoke-virtual {v2, v0}, Lm3/j;->c(Ljava/lang/String;)V
    ...
    invoke-direct {v2, v0, v1, v3}, Lb3/a$b;-><init>(Ljava/lang/String;Ljava/lang/String;Ljava/lang/String;)V
    ...
    invoke-virtual {v0, v1, v2}, Lb3/a;->i(Lb3/a$b;Ljava/util/List;)V
...
.method A(I[Ljava/lang/String;[I)V
    ...
    invoke-virtual {v0}, Lio/flutter/embedding/engine/a;->i()Lg3/b;

    move-result-object v0

    invoke-interface {v0, p1, p2, p3}, Lg3/b;->onRequestPermissionsResult(I[Ljava/lang/String;[I)Z
...
.method B(Landroid/os/Bundle;)V
    ...
    invoke-virtual {v1}, Lio/flutter/embedding/engine/a;->u()Lm3/o;

    move-result-object v1

    invoke-virtual {v1, p1}, Lm3/o;->j([B)V
    ...
    invoke-virtual {p1}, Lio/flutter/embedding/engine/a;->i()Lg3/b;

    move-result-object p1

    invoke-interface {p1, v0}, Lg3/b;->c(Landroid/os/Bundle;)V
...
.method C()V
    ...
    invoke-virtual {v0}, Lio/flutter/embedding/engine/a;->l()Lm3/g;
...
.method D(Landroid/os/Bundle;)V
    ...
    invoke-virtual {v0}, Lio/flutter/embedding/engine/a;->u()Lm3/o;

    move-result-object v0

    invoke-virtual {v0}, Lm3/o;->h()[B
    ...
    invoke-virtual {v1}, Lio/flutter/embedding/engine/a;->i()Lg3/b;

    move-result-object v1

    invoke-interface {v1, v0}, Lg3/b;->d(Landroid/os/Bundle;)V
...
.method E()V
    ...
    iget-object v1, p0, Lio/flutter/embedding/android/g;->c:Lio/flutter/embedding/android/y;

    invoke-virtual {v0}, Ljava/lang/Integer;->intValue()I

    move-result v0

    invoke-virtual {v1, v0}, Lio/flutter/embedding/android/y;->setVisibility(I)V
...
.method F()V
    ...
    :cond_0
    iget-object v0, p0, Lio/flutter/embedding/android/g;->c:Lio/flutter/embedding/android/y;
    ...
    invoke-virtual {v0, v1}, Lio/flutter/embedding/android/y;->setVisibility(I)V
...
.method G(I)V
    ...
    invoke-virtual {v0}, Lb3/a;->k()V

    iget-object v0, p0, Lio/flutter/embedding/android/g;->b:Lio/flutter/embedding/engine/a;

    invoke-virtual {v0}, Lio/flutter/embedding/engine/a;->x()Lm3/r;

    move-result-object v0

    invoke-virtual {v0}, Lm3/r;->a()V
...
.method H()V
    ...
    invoke-static {v1, v0}, La3/b;->g(Ljava/lang/String;Ljava/lang/String;)V
...
.method J()V
    ...
    iput-object v0, p0, Lio/flutter/embedding/android/g;->c:Lio/flutter/embedding/android/y;
...
.method K()V
    ...
    invoke-interface {v0, v4}, Lio/flutter/embedding/android/g$c;->B(Landroid/content/Context;)Lio/flutter/embedding/engine/a;
    ...
    invoke-direct {p0, v0}, Lio/flutter/embedding/android/g;->g(Lio/flutter/embedding/engine/d$b;)Lio/flutter/embedding/engine/d$b;
    ...
    invoke-interface {v2}, Lio/flutter/embedding/android/g$c;->y()Lio/flutter/embedding/engine/l;
...
.method L(Landroid/window/BackEvent;)V
    ...
    invoke-virtual {v0}, Lio/flutter/embedding/engine/a;->j()Lm3/b;

    move-result-object v0

    invoke-virtual {v0, p1}, Lm3/b;->d(Landroid/window/BackEvent;)V
...
.method M(Landroid/window/BackEvent;)V
    ...
    invoke-virtual {v0, p1}, Lm3/b;->e(Landroid/window/BackEvent;)V
...
.method r(IILandroid/content/Intent;)V
    ...
    invoke-interface {v0, p1, p2, p3}, Lg3/b;->a(IILandroid/content/Intent;)Z
...
.method s(Landroid/content/Context;)V
    ...
    invoke-interface {v0}, Lio/flutter/embedding/android/g$c;->a()Landroidx/lifecycle/h;

    move-result-object v0

    invoke-interface {p1, p0, v0}, Lg3/b;->g(Lio/flutter/embedding/android/d;Landroidx/lifecycle/h;)V
...
.method t()V
    ...
    invoke-virtual {v0}, Lio/flutter/embedding/engine/a;->o()Lm3/j;

    move-result-object v0

    invoke-virtual {v0}, Lm3/j;->a()V
...
.method u(Landroid/view/LayoutInflater;Landroid/view/ViewGroup;Landroid/os/Bundle;IZ)Landroid/view/View;
    ...
    invoke-static {p2, p1}, La3/b;->f(Ljava/lang/String;Ljava/lang/String;)V

    invoke-direct {p0}, Lio/flutter/embedding/android/g;->l()V

    iget-object p1, p0, Lio/flutter/embedding/android/g;->a:Lio/flutter/embedding/android/g$c;

    invoke-interface {p1}, Lio/flutter/embedding/android/g$c;->z()Lio/flutter/embedding/android/j0;

    move-result-object p1

    sget-object p3, Lio/flutter/embedding/android/j0;->e:Lio/flutter/embedding/android/j0;
    ...
    invoke-interface {v2}, Lio/flutter/embedding/android/g$c;->C()Lio/flutter/embedding/android/k0;

    move-result-object v2

    sget-object v3, Lio/flutter/embedding/android/k0;->f:Lio/flutter/embedding/android/k0;
    ...
    :goto_0
    invoke-direct {p1, p3, v0}, Lio/flutter/embedding/android/p;-><init>(Landroid/content/Context;Z)V

    iget-object p3, p0, Lio/flutter/embedding/android/g;->a:Lio/flutter/embedding/android/g$c;

    invoke-interface {p3, p1}, Lio/flutter/embedding/android/g$c;->v(Lio/flutter/embedding/android/p;)V

    new-instance p3, Lio/flutter/embedding/android/y;
    ...
    invoke-direct {p3, v0, p1}, Lio/flutter/embedding/android/y;-><init>(Landroid/content/Context;Lio/flutter/embedding/android/p;)V

    goto :goto_2

    :cond_1
    new-instance p1, Lio/flutter/embedding/android/q;
    ...
    invoke-direct {p1, p3}, Lio/flutter/embedding/android/q;-><init>(Landroid/content/Context;)V

    iget-object p3, p0, Lio/flutter/embedding/android/g;->a:Lio/flutter/embedding/android/g$c;

    invoke-interface {p3}, Lio/flutter/embedding/android/g$c;->C()Lio/flutter/embedding/android/k0;
    ...
    invoke-interface {p3, p1}, Lio/flutter/embedding/android/g$c;->D(Lio/flutter/embedding/android/q;)V
    ...
    invoke-direct {p3, v0, p1}, Lio/flutter/embedding/android/y;-><init>(Landroid/content/Context;Lio/flutter/embedding/android/q;)V

    :goto_2
    iput-object p3, p0, Lio/flutter/embedding/android/g;->c:Lio/flutter/embedding/android/y;

    iget-object p1, p0, Lio/flutter/embedding/android/g;->c:Lio/flutter/embedding/android/y;

    iget-object p3, p0, Lio/flutter/embedding/android/g;->l:Lio/flutter/embedding/engine/renderer/d;

    invoke-virtual {p1, p3}, Lio/flutter/embedding/android/y;->l(Lio/flutter/embedding/engine/renderer/d;)V

    iget-object p1, p0, Lio/flutter/embedding/android/g;->a:Lio/flutter/embedding/android/g$c;

    invoke-interface {p1}, Lio/flutter/embedding/android/g$c;->A()Z
    ...
    invoke-virtual {p1, p2}, Lio/flutter/embedding/android/y;->n(Lio/flutter/embedding/engine/a;)V
    ...
    invoke-direct {p0, p1}, Lio/flutter/embedding/android/g;->j(Lio/flutter/embedding/android/y;)V
...
.method v()V
    ...
    invoke-virtual {v0}, Lio/flutter/embedding/android/y;->s()V

    iget-object v0, p0, Lio/flutter/embedding/android/g;->c:Lio/flutter/embedding/android/y;

    iget-object v1, p0, Lio/flutter/embedding/android/g;->l:Lio/flutter/embedding/engine/renderer/d;

    invoke-virtual {v0, v1}, Lio/flutter/embedding/android/y;->y(Lio/flutter/embedding/engine/renderer/d;)V
...
.method w()V
    ...
    invoke-interface {v0, v2}, Lio/flutter/embedding/android/g$c;->s(Lio/flutter/embedding/engine/a;)V
...
.method x(Landroid/content/Intent;)V
    ...
    invoke-interface {v0, p1}, Lg3/b;->b(Landroid/content/Intent;)V
    ...
    invoke-virtual {v0, p1}, Lm3/j;->b(Ljava/lang/String;)V
