...
.method public static decodeImage(Ljava/nio/ByteBuffer;J)Landroid/graphics/Bitmap;
    ...
    invoke-static {p0}, Lio/flutter/embedding/engine/f;->a(Ljava/nio/ByteBuffer;)Landroid/graphics/ImageDecoder$Source;
    ...
    invoke-direct {v0, p1, p2}, Lio/flutter/embedding/engine/k;-><init>(J)V

    invoke-static {p0, v0}, Lio/flutter/embedding/engine/g;->a(Landroid/graphics/ImageDecoder$Source;Landroid/graphics/ImageDecoder$OnHeaderDecodedListener;)Landroid/graphics/Bitmap;
    ...
    invoke-static {p1, p2, p0}, La3/b;->c(Ljava/lang/String;Ljava/lang/String;Ljava/lang/Throwable;)V
...
.method private handlePlatformMessageResponse(ILjava/nio/ByteBuffer;)V
    ...
    iget-object v0, p0, Lio/flutter/embedding/engine/FlutterJNI;->platformMessageHandler:Lb3/f;

    if-eqz v0, :cond_0

    invoke-interface {v0, p1, p2}, Lb3/f;->g(ILjava/nio/ByteBuffer;)V
...
.method private static synthetic lambda$decodeImage$0(JLandroid/graphics/ImageDecoder;Landroid/graphics/ImageDecoder$ImageInfo;Landroid/graphics/ImageDecoder$Source;)V
    ...
    invoke-static {p4}, Lio/flutter/embedding/android/l;->a(Landroid/graphics/ColorSpace$Named;)Landroid/graphics/ColorSpace;

    move-result-object p4

    invoke-static {p2, p4}, Lio/flutter/embedding/engine/h;->a(Landroid/graphics/ImageDecoder;Landroid/graphics/ColorSpace;)V

    const/4 p4, 0x1

    invoke-static {p2, p4}, Lio/flutter/embedding/engine/i;->a(Landroid/graphics/ImageDecoder;I)V

    invoke-static {p3}, Lio/flutter/embedding/engine/j;->a(Landroid/graphics/ImageDecoder$ImageInfo;)Landroid/util/Size;
...
.method public computePlatformResolvedLocale([Ljava/lang/String;)[Ljava/lang/String;
    ...
    iget-object v0, p0, Lio/flutter/embedding/engine/FlutterJNI;->localizationPlugin:Lo3/b;
    ...
    :cond_4
    iget-object p1, p0, Lio/flutter/embedding/engine/FlutterJNI;->localizationPlugin:Lo3/b;

    invoke-virtual {p1, v0}, Lo3/b;->c(Ljava/util/List;)Ljava/util/Locale;
...
.method public dispatchEmptyPlatformMessage(Ljava/lang/String;I)V
    ...
    invoke-static {p2, p1}, La3/b;->g(Ljava/lang/String;Ljava/lang/String;)V
...
.method public dispatchSemanticsAction(ILio/flutter/view/i$g;Ljava/lang/Object;)V
    ...
    invoke-virtual {v0, p3}, Ln3/q;->a(Ljava/lang/Object;)Ljava/nio/ByteBuffer;
    ...
    :goto_0
    iget p2, p2, Lio/flutter/view/i$g;->e:I
...
.method public getScaledFontSize(FI)F
    ...
    invoke-static {p2}, Lm3/p;->b(I)Landroid/util/DisplayMetrics;
...
.method public handlePlatformMessage(Ljava/lang/String;Ljava/nio/ByteBuffer;IJ)V
    ...
    invoke-interface/range {v0 .. v5}, Lb3/f;->h(Ljava/lang/String;Ljava/nio/ByteBuffer;IJ)V
...
.method public requestDartDeferredLibrary(I)V
    ...
    invoke-static {p1, v0}, La3/b;->b(Ljava/lang/String;Ljava/lang/String;)V
...
.method public setDeferredComponentManager(Lc3/a;)V
    ...
    invoke-interface {p1, p0}, Lc3/a;->a(Lio/flutter/embedding/engine/FlutterJNI;)V

    :cond_0
    return-void
.end method

.method public setLocalizationPlugin(Lo3/b;)V
    .locals 0

    invoke-direct {p0}, Lio/flutter/embedding/engine/FlutterJNI;->ensureRunningOnMainThread()V

    iput-object p1, p0, Lio/flutter/embedding/engine/FlutterJNI;->localizationPlugin:Lo3/b;

    return-void
.end method

.method public setPlatformMessageHandler(Lb3/f;)V
    .locals 0

    invoke-direct {p0}, Lio/flutter/embedding/engine/FlutterJNI;->ensureRunningOnMainThread()V

    iput-object p1, p0, Lio/flutter/embedding/engine/FlutterJNI;->platformMessageHandler:Lb3/f;
...
.method public spawn(Ljava/lang/String;Ljava/lang/String;Ljava/lang/String;Ljava/util/List;)Lio/flutter/embedding/engine/FlutterJNI;
    ...
    invoke-static {p2, p3}, Lx3/d;->a(ZLjava/lang/Object;)V
