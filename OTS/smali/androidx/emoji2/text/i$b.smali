...
# direct methods
.method constructor <init>(Landroid/content/Context;Ls/g;Landroidx/emoji2/text/i$a;)V
    .locals 1
    ...
    invoke-static {p2, v0}, Lu/e;->k(Ljava/lang/Object;Ljava/lang/Object;)Ljava/lang/Object;
    ...
    iput-object p2, p0, Landroidx/emoji2/text/i$b;->b:Ls/g;
...
.method private e()Ls/i$b;
    ...
    iget-object v2, p0, Landroidx/emoji2/text/i$b;->b:Ls/g;

    invoke-virtual {v0, v1, v2}, Landroidx/emoji2/text/i$a;->b(Landroid/content/Context;Ls/g;)Ls/i$a;

    move-result-object v0
    :try_end_0
    .catch Landroid/content/pm/PackageManager$NameNotFoundException; {:try_start_0 .. :try_end_0} :catch_0

    invoke-virtual {v0}, Ls/i$a;->c()I

    move-result v1

    if-nez v1, :cond_1

    invoke-virtual {v0}, Ls/i$a;->b()[Ls/i$b;
...
.method c()V
    ...
    :try_start_1
    invoke-direct {p0}, Landroidx/emoji2/text/i$b;->e()Ls/i$b;

    move-result-object v0

    invoke-virtual {v0}, Ls/i$b;->b()I
    ...
    invoke-virtual {v1, v2, v0}, Landroidx/emoji2/text/i$a;->a(Landroid/content/Context;Ls/i$b;)Landroid/graphics/Typeface;

    move-result-object v1

    iget-object v2, p0, Landroidx/emoji2/text/i$b;->a:Landroid/content/Context;

    invoke-virtual {v0}, Ls/i$b;->d()Landroid/net/Uri;

    move-result-object v0

    const/4 v3, 0x0

    invoke-static {v2, v3, v0}, Landroidx/core/graphics/j0;->f(Landroid/content/Context;Landroid/os/CancellationSignal;Landroid/net/Uri;)Ljava/nio/ByteBuffer;
