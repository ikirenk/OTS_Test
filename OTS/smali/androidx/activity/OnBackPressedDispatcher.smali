...
.field private d:Landroidx/activity/r;
...
.method public constructor <init>(Ljava/lang/Runnable;Lu/a;)V
    ...
    iput-object p1, p0, Landroidx/activity/OnBackPressedDispatcher;->c:Lz3/e;
    ...
    invoke-virtual {p1, p2, v0, v1, v2}, Landroidx/activity/OnBackPressedDispatcher$g;->a(Lh4/l;Lh4/l;Lh4/a;Lh4/a;)Landroid/window/OnBackInvokedCallback;
    ...
    invoke-virtual {p1, p2}, Landroidx/activity/OnBackPressedDispatcher$f;->b(Lh4/a;)Landroid/window/OnBackInvokedCallback;
...
.method public static final synthetic a(Landroidx/activity/OnBackPressedDispatcher;)Landroidx/activity/r;
    .locals 0

    iget-object p0, p0, Landroidx/activity/OnBackPressedDispatcher;->d:Landroidx/activity/r;

    return-object p0
.end method

.method public static final synthetic b(Landroidx/activity/OnBackPressedDispatcher;)Lz3/e;
    .locals 0

    iget-object p0, p0, Landroidx/activity/OnBackPressedDispatcher;->c:Lz3/e;
...
.method public static final synthetic f(Landroidx/activity/OnBackPressedDispatcher;Landroidx/activity/r;)V
    .locals 0

    iput-object p1, p0, Landroidx/activity/OnBackPressedDispatcher;->d:Landroidx/activity/r;
...
.method private final j()V
    ...
    iget-object v0, p0, Landroidx/activity/OnBackPressedDispatcher;->d:Landroidx/activity/r;

    const/4 v1, 0x0

    if-nez v0, :cond_2

    iget-object v0, p0, Landroidx/activity/OnBackPressedDispatcher;->c:Lz3/e;
    ...
    check-cast v3, Landroidx/activity/r;

    invoke-virtual {v3}, Landroidx/activity/r;->g()Z
    ...
    :cond_2
    iput-object v1, p0, Landroidx/activity/OnBackPressedDispatcher;->d:Landroidx/activity/r;
...
.method private final l(Landroidx/activity/b;)V
    ...
    invoke-virtual {v2}, Landroidx/activity/r;->g()Z
    ...
    invoke-virtual {v0, p1}, Landroidx/activity/r;->e(Landroidx/activity/b;)V
...
.method private final m(Landroidx/activity/b;)V
    ...
    invoke-virtual {v1, p1}, Landroidx/activity/r;->f(Landroidx/activity/b;)V
...
.method private final p()V
    ...
    iget-object v1, p0, Landroidx/activity/OnBackPressedDispatcher;->c:Lz3/e;
...
# virtual methods
.method public final h(Landroidx/lifecycle/m;Landroidx/activity/r;)V
    .locals 2
    ...
    invoke-direct {v0, p0, p1, p2}, Landroidx/activity/OnBackPressedDispatcher$LifecycleOnBackPressedCancellable;-><init>(Landroidx/activity/OnBackPressedDispatcher;Landroidx/lifecycle/h;Landroidx/activity/r;)V

    invoke-virtual {p2, v0}, Landroidx/activity/r;->a(Landroidx/activity/c;)V
    ...
    invoke-virtual {p2, p1}, Landroidx/activity/r;->k(Lh4/a;)V

    return-void
.end method

.method public final i(Landroidx/activity/r;)Landroidx/activity/c;
    .locals 2
    ...
    invoke-virtual {v0, p1}, Lz3/e;->add(Ljava/lang/Object;)Z

    new-instance v0, Landroidx/activity/OnBackPressedDispatcher$h;

    invoke-direct {v0, p0, p1}, Landroidx/activity/OnBackPressedDispatcher$h;-><init>(Landroidx/activity/OnBackPressedDispatcher;Landroidx/activity/r;)V

    invoke-virtual {p1, v0}, Landroidx/activity/r;->a(Landroidx/activity/c;)V
    ...
    invoke-virtual {p1, v1}, Landroidx/activity/r;->k(Lh4/a;)V
...
.method public final k()V
    ...
    invoke-virtual {v0}, Landroidx/activity/r;->d()V
