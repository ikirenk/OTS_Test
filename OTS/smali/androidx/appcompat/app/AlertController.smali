...
# direct methods
.method public constructor <init>(Landroid/content/Context;Lf/k;Landroid/view/Window;)V
    .locals 3
    ...
    iput-object p2, p0, Landroidx/appcompat/app/AlertController;->b:Lf/k;
    ...
    invoke-virtual {p2, v1}, Lf/k;->e(I)Z
...
.method private p(Landroid/view/ViewGroup;Landroid/view/View;II)V
    ...
    invoke-static {p2, p3, p4}, Landroidx/core/view/c1;->Z(Landroid/view/View;II)V
...
.method private w(Landroid/view/ViewGroup;)V
    ...
    check-cast p1, Landroidx/appcompat/widget/e2$a;
...
.method public e()V
    ...
    iget-object v1, p0, Landroidx/appcompat/app/AlertController;->b:Lf/k;

    invoke-virtual {v1, v0}, Lf/k;->setContentView(I)V
