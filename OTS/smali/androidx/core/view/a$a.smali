...
.method public getAccessibilityNodeProvider(Landroid/view/View;)Landroid/view/accessibility/AccessibilityNodeProvider;
    ...
    invoke-virtual {v0, p1}, Landroidx/core/view/a;->b(Landroid/view/View;)Lv/e0;

    move-result-object p1

    if-eqz p1, :cond_0

    invoke-virtual {p1}, Lv/e0;->a()Ljava/lang/Object;
...
.method public onInitializeAccessibilityNodeInfo(Landroid/view/View;Landroid/view/accessibility/AccessibilityNodeInfo;)V
    ...
    invoke-static {p2}, Lv/y;->c0(Landroid/view/accessibility/AccessibilityNodeInfo;)Lv/y;

    move-result-object v0

    invoke-static {p1}, Landroidx/core/view/c1;->C(Landroid/view/View;)Z

    move-result v1

    invoke-virtual {v0, v1}, Lv/y;->Y(Z)V

    invoke-static {p1}, Landroidx/core/view/c1;->z(Landroid/view/View;)Z

    move-result v1

    invoke-virtual {v0, v1}, Lv/y;->W(Z)V

    invoke-static {p1}, Landroidx/core/view/c1;->l(Landroid/view/View;)Ljava/lang/CharSequence;

    move-result-object v1

    invoke-virtual {v0, v1}, Lv/y;->X(Ljava/lang/CharSequence;)V

    invoke-static {p1}, Landroidx/core/view/c1;->u(Landroid/view/View;)Ljava/lang/CharSequence;

    move-result-object v1

    invoke-virtual {v0, v1}, Lv/y;->a0(Ljava/lang/CharSequence;)V

    iget-object v1, p0, Landroidx/core/view/a$a;->a:Landroidx/core/view/a;

    invoke-virtual {v1, p1, v0}, Landroidx/core/view/a;->g(Landroid/view/View;Lv/y;)V

    invoke-virtual {p2}, Landroid/view/accessibility/AccessibilityNodeInfo;->getText()Ljava/lang/CharSequence;

    move-result-object p2

    invoke-virtual {v0, p2, p1}, Lv/y;->c(Ljava/lang/CharSequence;Landroid/view/View;)V
    ...
    invoke-virtual {v0, v1}, Lv/y;->a(Lv/y$a;)V
