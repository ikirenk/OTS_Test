...
# static fields
.field private static w:[Ljava/lang/Class; = null
...
.field private d:Lio/flutter/embedding/android/y;

.field private e:Lio/flutter/view/TextureRegistry;

.field private f:Lio/flutter/plugin/editing/a0;

.field private g:Lm3/m;
...
.field private final t:Lio/flutter/embedding/android/i0;

.field private u:Z

.field private final v:Lm3/m$g;
...
.method static constructor <clinit>()V
    ...
    sput-object v0, Lio/flutter/plugin/platform/x;->w:[Ljava/lang/Class;
...
.method public constructor <init>()V
    ...
    iput-object v0, p0, Lio/flutter/plugin/platform/x;->v:Lm3/m$g;
    ...
    invoke-static {}, Lio/flutter/embedding/android/i0;->a()Lio/flutter/embedding/android/i0;

    move-result-object v0

    iput-object v0, p0, Lio/flutter/plugin/platform/x;->t:Lio/flutter/embedding/android/i0;

    return-void
.end method

.method static synthetic A(Lio/flutter/plugin/platform/x;Lio/flutter/plugin/platform/j;Lm3/m$d;)J
    .locals 0

    invoke-direct {p0, p1, p2}, Lio/flutter/plugin/platform/x;->J(Lio/flutter/plugin/platform/j;Lm3/m$d;)J
...
.method private A0(Lio/flutter/plugin/platform/h0;)V
    ...
    iget-object v0, p0, Lio/flutter/plugin/platform/x;->f:Lio/flutter/plugin/editing/a0;
    ...
    :cond_0
    invoke-virtual {v0}, Lio/flutter/plugin/editing/a0;->F()V
...
.method private H(Lio/flutter/plugin/platform/j;Lm3/m$d;)V
    .locals 1
    ...
    invoke-static {p2, p1}, La3/b;->e(Ljava/lang/String;Ljava/lang/String;)V

    return-void
.end method

.method private J(Lio/flutter/plugin/platform/j;Lm3/m$d;)J
    .locals 10
    ...
    invoke-static {v1, v0}, La3/b;->e(Ljava/lang/String;Ljava/lang/String;)V
    ...
    iget v7, p2, Lm3/m$d;->a:I

    const/4 v8, 0x0

    new-instance v9, Lio/flutter/plugin/platform/v;

    invoke-direct {v9, p0, p2}, Lio/flutter/plugin/platform/v;-><init>(Lio/flutter/plugin/platform/x;Lm3/m$d;)V
    ...
    invoke-interface {p1}, Lio/flutter/plugin/platform/j;->d()Landroid/view/View;
    ...
    iget-object v1, p2, Lm3/m$d;->b:Ljava/lang/String;
...
.method private R()V
    ...
    iget-object v1, p0, Lio/flutter/plugin/platform/x;->v:Lm3/m$g;

    invoke-interface {v1, v0}, Lm3/m$g;->i(I)V
...
.method private T(Lm3/m$d;)V
    .locals 3

    iget v0, p1, Lm3/m$d;->g:I
...
.method private U(Z)V
    ...
    iget-object v2, p0, Lio/flutter/plugin/platform/x;->d:Lio/flutter/embedding/android/y;

    invoke-virtual {v2, v4}, Lio/flutter/embedding/android/y;->m(Lio/flutter/embedding/android/o;)V

    invoke-virtual {v4}, Lio/flutter/embedding/android/o;->e()Z
    ...
    invoke-virtual {v4}, Lio/flutter/embedding/android/o;->a()V
...
.method private Y()V
    ...
    iget-object v0, p0, Lio/flutter/plugin/platform/x;->d:Lio/flutter/embedding/android/y;

    invoke-virtual {v0}, Lio/flutter/embedding/android/y;->p()V
...
.method private synthetic Z(Lm3/m$d;Landroid/view/View;Z)V
    .locals 0

    if-eqz p3, :cond_0

    iget-object p2, p0, Lio/flutter/plugin/platform/x;->g:Lm3/m;

    iget p1, p1, Lm3/m$d;->a:I

    invoke-virtual {p2, p1}, Lm3/m;->d(I)V

    goto :goto_0

    :cond_0
    iget-object p2, p0, Lio/flutter/plugin/platform/x;->f:Lio/flutter/plugin/editing/a0;

    if-eqz p2, :cond_1

    iget p1, p1, Lm3/m$d;->a:I

    invoke-virtual {p2, p1}, Lio/flutter/plugin/editing/a0;->k(I)V
...
.method private synthetic a0(Lm3/m$d;Landroid/view/View;Z)V
    .locals 0
...
.method private d0(Lio/flutter/plugin/platform/h0;)V
    ...
    :cond_0
    invoke-virtual {v0}, Lio/flutter/plugin/editing/a0;->t()V
...
.method private static e0(Lio/flutter/view/TextureRegistry;)Lio/flutter/plugin/platform/o;
    ...
    invoke-static {v2, v0}, La3/b;->e(Ljava/lang/String;Ljava/lang/String;)V
...
.method public static synthetic f(Lio/flutter/plugin/platform/x;Lm3/m$d;Landroid/view/View;Z)V
    .locals 0

    invoke-direct {p0, p1, p2, p3}, Lio/flutter/plugin/platform/x;->a0(Lm3/m$d;Landroid/view/View;Z)V
...
.method private f0(Lio/flutter/plugin/platform/j;)V
    ...
    invoke-static {p1, v0}, La3/b;->e(Ljava/lang/String;Ljava/lang/String;)V

    return-void

    :cond_0
    invoke-interface {p1, v0}, Lio/flutter/plugin/platform/j;->e(Landroid/view/View;)V

    return-void
.end method

.method public static synthetic g(Lio/flutter/plugin/platform/x;Lm3/m$d;Landroid/view/View;Z)V
    .locals 0

    invoke-direct {p0, p1, p2, p3}, Lio/flutter/plugin/platform/x;->Z(Lm3/m$d;Landroid/view/View;Z)V
...
.method static synthetic j(Lio/flutter/plugin/platform/x;Lm3/m$d;)V
    .locals 0

    invoke-direct {p0, p1}, Lio/flutter/plugin/platform/x;->T(Lm3/m$d;)V
...
.method private t0()V
    ...
    invoke-static {v0, v1}, La3/b;->b(Ljava/lang/String;Ljava/lang/String;)V
    ...
    iget-object v1, p0, Lio/flutter/plugin/platform/x;->d:Lio/flutter/embedding/android/y;
...
.method static synthetic u(Lio/flutter/plugin/platform/x;Lio/flutter/plugin/platform/j;Lm3/m$d;)V
    .locals 0

    invoke-direct {p0, p1, p2}, Lio/flutter/plugin/platform/x;->H(Lio/flutter/plugin/platform/j;Lm3/m$d;)V
...
.method static synthetic x(Lio/flutter/plugin/platform/x;)Lio/flutter/embedding/android/y;
    .locals 0

    iget-object p0, p0, Lio/flutter/plugin/platform/x;->d:Lio/flutter/embedding/android/y;
...
# virtual methods
.method public C(Landroid/content/Context;Lio/flutter/view/TextureRegistry;Lb3/a;)V
    .locals 1
    ...
    invoke-direct {p1, p3}, Lm3/m;-><init>(Lb3/a;)V

    iput-object p1, p0, Lio/flutter/plugin/platform/x;->g:Lm3/m;

    iget-object p2, p0, Lio/flutter/plugin/platform/x;->v:Lm3/m$g;

    invoke-virtual {p1, p2}, Lm3/m;->e(Lm3/m$g;)V
...
.method public D(Lio/flutter/plugin/editing/a0;)V
    .locals 0

    iput-object p1, p0, Lio/flutter/plugin/platform/x;->f:Lio/flutter/plugin/editing/a0;
...
.method public F(Lio/flutter/embedding/android/y;)V
    .locals 3

    iput-object p1, p0, Lio/flutter/plugin/platform/x;->d:Lio/flutter/embedding/android/y;
    ...
    invoke-interface {v0, v1}, Lio/flutter/plugin/platform/j;->e(Landroid/view/View;)V
...
.method public I(Lio/flutter/plugin/platform/j;Lm3/m$d;)J
    .locals 9
    ...
    invoke-direct {v0, p0, p2}, Lio/flutter/plugin/platform/u;-><init>(Lio/flutter/plugin/platform/x;Lm3/m$d;)V
...
.method public K()Lio/flutter/embedding/engine/FlutterOverlaySurface;
    ...
    iget-object v3, p0, Lio/flutter/plugin/platform/x;->d:Lio/flutter/embedding/android/y;
...
.method public L(Lio/flutter/plugin/platform/c;)Lio/flutter/embedding/engine/FlutterOverlaySurface;
    ...
    invoke-virtual {p1}, Lio/flutter/embedding/android/o;->getSurface()Landroid/view/Surface;
...
.method public M(Lm3/m$d;Z)Lio/flutter/plugin/platform/j;
    .locals 3

    iget-object v0, p0, Lio/flutter/plugin/platform/x;->a:Lio/flutter/plugin/platform/m;

    iget-object v1, p1, Lm3/m$d;->b:Ljava/lang/String;
    ...
    iget-object v1, p1, Lm3/m$d;->i:Ljava/nio/ByteBuffer;

    if-eqz v1, :cond_0

    invoke-virtual {v0}, Lio/flutter/plugin/platform/k;->b()Ln3/i;

    move-result-object v1

    iget-object v2, p1, Lm3/m$d;->i:Ljava/nio/ByteBuffer;

    invoke-interface {v1, v2}, Ln3/i;->b(Ljava/nio/ByteBuffer;)Ljava/lang/Object;
    ...
    invoke-interface {p2}, Lio/flutter/plugin/platform/j;->d()Landroid/view/View;

    move-result-object v0

    if-eqz v0, :cond_2

    iget v1, p1, Lm3/m$d;->g:I
    ...
    iget-object p1, p1, Lm3/m$d;->b:Ljava/lang/String;
...
.method public N()V
    ...
    invoke-virtual {v1}, Lio/flutter/embedding/android/o;->a()V

    invoke-virtual {v1}, Lio/flutter/embedding/android/o;->g()V
...
.method public O()V
    ...
    iget-object v0, p0, Lio/flutter/plugin/platform/x;->g:Lm3/m;

    const/4 v1, 0x0

    if-eqz v0, :cond_0

    invoke-virtual {v0, v1}, Lm3/m;->e(Lm3/m$g;)V

    :cond_0
    invoke-virtual {p0}, Lio/flutter/plugin/platform/x;->N()V

    iput-object v1, p0, Lio/flutter/plugin/platform/x;->g:Lm3/m;
...
.method public P()V
    ...
    iput-object v1, p0, Lio/flutter/plugin/platform/x;->d:Lio/flutter/embedding/android/y;
...
.method public Q()V
    ...
    iput-object v0, p0, Lio/flutter/plugin/platform/x;->f:Lio/flutter/plugin/editing/a0;
...
.method X(I)V
    ...
    :cond_0
    invoke-interface {v0}, Lio/flutter/plugin/platform/j;->d()Landroid/view/View;
    ...
    invoke-direct {v1, v2, v3, v4}, Le3/a;-><init>(Landroid/content/Context;FLio/flutter/embedding/android/c;)V
    ...
    invoke-virtual {v1, v2}, Le3/a;->setOnDescendantFocusChangeListener(Landroid/view/View$OnFocusChangeListener;)V
    ...
    iget-object p1, p0, Lio/flutter/plugin/platform/x;->d:Lio/flutter/embedding/android/y;
...
.method public a(Lio/flutter/view/i;)V
    ...
    invoke-virtual {v0, p1}, Lio/flutter/plugin/platform/a;->c(Lio/flutter/view/i;)V
...
.method public d()V
    ...
    invoke-virtual {v0, v1}, Lio/flutter/plugin/platform/a;->c(Lio/flutter/view/i;)V
...
.method public k0(IIIIIIILio/flutter/embedding/engine/mutatorsstack/FlutterMutatorsStack;)V
    ...
    invoke-virtual/range {v1 .. v6}, Le3/a;->a(Lio/flutter/embedding/engine/mutatorsstack/FlutterMutatorsStack;IIII)V
    ...
    invoke-interface {p3}, Lio/flutter/plugin/platform/j;->d()Landroid/view/View;
...
.method public l0()V
    ...
    invoke-virtual {v0, v1}, Lio/flutter/embedding/android/y;->A(Ljava/lang/Runnable;)V
    ...
    invoke-virtual {v0}, Lio/flutter/embedding/android/y;->k()Z
...
.method public x0(FLm3/m$f;Z)Landroid/view/MotionEvent;
    .locals 20

    move-object/from16 v0, p2

    iget-wide v1, v0, Lm3/m$f;->p:J

    invoke-static {v1, v2}, Lio/flutter/embedding/android/i0$a;->c(J)Lio/flutter/embedding/android/i0$a;

    move-result-object v1

    move-object/from16 v2, p0

    iget-object v3, v2, Lio/flutter/plugin/platform/x;->t:Lio/flutter/embedding/android/i0;

    invoke-virtual {v3, v1}, Lio/flutter/embedding/android/i0;->b(Lio/flutter/embedding/android/i0$a;)Landroid/view/MotionEvent;

    move-result-object v1

    iget-object v3, v0, Lm3/m$f;->g:Ljava/lang/Object;
    ...
    iget-object v1, v0, Lm3/m$f;->b:Ljava/lang/Number;

    invoke-virtual {v1}, Ljava/lang/Number;->longValue()J

    move-result-wide v4

    iget-object v1, v0, Lm3/m$f;->c:Ljava/lang/Number;

    invoke-virtual {v1}, Ljava/lang/Number;->longValue()J

    move-result-wide v6

    iget v8, v0, Lm3/m$f;->d:I

    iget v9, v0, Lm3/m$f;->e:I

    iget v12, v0, Lm3/m$f;->h:I

    iget v13, v0, Lm3/m$f;->i:I

    iget v14, v0, Lm3/m$f;->j:F

    iget v15, v0, Lm3/m$f;->k:F

    iget v1, v0, Lm3/m$f;->l:I

    iget v3, v0, Lm3/m$f;->m:I

    iget v2, v0, Lm3/m$f;->n:I

    iget v0, v0, Lm3/m$f;->o:I
