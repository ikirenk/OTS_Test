...
# direct methods
.method constructor <init>(Lio/flutter/plugins/imagepicker/ImagePickerPlugin;Landroid/app/Application;Landroid/app/Activity;Ln3/c;Lio/flutter/plugins/imagepicker/q$f;Lg3/c;)V
    .locals 0
    ...
    iput-object p6, p0, Lio/flutter/plugins/imagepicker/ImagePickerPlugin$b;->e:Lg3/c;

    iput-object p4, p0, Lio/flutter/plugins/imagepicker/ImagePickerPlugin$b;->f:Ln3/c;
    ...
    invoke-static {p4, p5}, Lio/flutter/plugins/imagepicker/v;->f(Ln3/c;Lio/flutter/plugins/imagepicker/q$f;)V
    ...
    invoke-interface {p6, p1}, Lg3/c;->g(Ln3/m;)V

    iget-object p1, p0, Lio/flutter/plugins/imagepicker/ImagePickerPlugin$b;->c:Lio/flutter/plugins/imagepicker/l;

    invoke-interface {p6, p1}, Lg3/c;->e(Ln3/o;)V

    invoke-static {p6}, Lj3/a;->a(Lg3/c;)Landroidx/lifecycle/h;
...
.method c()V
    ...
    iget-object v0, p0, Lio/flutter/plugins/imagepicker/ImagePickerPlugin$b;->e:Lg3/c;
    ...
    invoke-interface {v0, v2}, Lg3/c;->f(Ln3/m;)V

    iget-object v0, p0, Lio/flutter/plugins/imagepicker/ImagePickerPlugin$b;->e:Lg3/c;

    iget-object v2, p0, Lio/flutter/plugins/imagepicker/ImagePickerPlugin$b;->c:Lio/flutter/plugins/imagepicker/l;

    invoke-interface {v0, v2}, Lg3/c;->h(Ln3/o;)V

    iput-object v1, p0, Lio/flutter/plugins/imagepicker/ImagePickerPlugin$b;->e:Lg3/c;
    ...
    :cond_1
    iget-object v0, p0, Lio/flutter/plugins/imagepicker/ImagePickerPlugin$b;->f:Ln3/c;

    invoke-static {v0, v1}, Lio/flutter/plugins/imagepicker/v;->f(Ln3/c;Lio/flutter/plugins/imagepicker/q$f;)V
