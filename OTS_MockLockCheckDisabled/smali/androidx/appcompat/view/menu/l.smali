...
.field final m:Landroidx/appcompat/widget/n2;
...
.method public constructor <init>(Landroid/content/Context;Landroidx/appcompat/view/menu/e;Landroid/view/View;IIZ)V
    ...
    new-instance p3, Landroidx/appcompat/widget/n2;

    const/4 p6, 0x0

    invoke-direct {p3, p1, p6, p4, p5}, Landroidx/appcompat/widget/n2;-><init>(Landroid/content/Context;Landroid/util/AttributeSet;II)V

    iput-object p3, p0, Landroidx/appcompat/view/menu/l;->m:Landroidx/appcompat/widget/n2;
...
.method private z()Z
    ...
    iget-object v0, p0, Landroidx/appcompat/view/menu/l;->m:Landroidx/appcompat/widget/n2;
    ...
    iget-object v3, p0, Landroidx/appcompat/view/menu/l;->m:Landroidx/appcompat/widget/n2;

    invoke-virtual {v3, v0}, Landroidx/appcompat/widget/i2;->z(Landroid/view/View;)V

    iget-object v0, p0, Landroidx/appcompat/view/menu/l;->m:Landroidx/appcompat/widget/n2;

    iget v3, p0, Landroidx/appcompat/view/menu/l;->x:I

    invoke-virtual {v0, v3}, Landroidx/appcompat/widget/i2;->C(I)V
    ...
    invoke-virtual {v0, v4}, Landroidx/appcompat/widget/i2;->B(I)V

    iget-object v0, p0, Landroidx/appcompat/view/menu/l;->m:Landroidx/appcompat/widget/n2;

    const/4 v4, 0x2

    invoke-virtual {v0, v4}, Landroidx/appcompat/widget/i2;->E(I)V
    ...
    invoke-virtual {v0, v4}, Landroidx/appcompat/widget/i2;->D(Landroid/graphics/Rect;)V
    ...
    invoke-virtual {v0}, Landroidx/appcompat/widget/i2;->g()Landroid/widget/ListView;
    ...
    invoke-virtual {v0, v2}, Landroidx/appcompat/widget/i2;->p(Landroid/widget/ListAdapter;)V
...
.method public e(Landroidx/appcompat/view/menu/m;)Z
    ...
    iget-object v2, p0, Landroidx/appcompat/view/menu/l;->m:Landroidx/appcompat/widget/n2;

    invoke-virtual {v2}, Landroidx/appcompat/widget/i2;->d()I

    move-result v2

    iget-object v3, p0, Landroidx/appcompat/view/menu/l;->m:Landroidx/appcompat/widget/n2;

    invoke-virtual {v3}, Landroidx/appcompat/widget/i2;->n()I
    ...
    invoke-static {v5}, Landroidx/core/view/c1;->q(Landroid/view/View;)I
...
.method public t(I)V
    ...
    invoke-virtual {v0, p1}, Landroidx/appcompat/widget/i2;->l(I)V
...
.method public w(I)V
    ...
    invoke-virtual {v0, p1}, Landroidx/appcompat/widget/i2;->j(I)V
