...
.field private final p:Landroidx/appcompat/widget/j2;
...
.method public constructor <init>(Landroid/content/Context;Landroid/view/View;IIZ)V
    ...
    iput-object v0, p0, Landroidx/appcompat/view/menu/b;->p:Landroidx/appcompat/widget/j2;
...
.method private D()I
    ...
    invoke-static {v0}, Landroidx/core/view/c1;->q(Landroid/view/View;)I
...
.method private F(Landroidx/appcompat/view/menu/e;)V
    ...
    invoke-direct {p0}, Landroidx/appcompat/view/menu/b;->z()Landroidx/appcompat/widget/n2;

    move-result-object v4

    invoke-virtual {v4, v1}, Landroidx/appcompat/widget/i2;->p(Landroid/widget/ListAdapter;)V

    invoke-virtual {v4, v2}, Landroidx/appcompat/widget/i2;->B(I)V

    iget v1, p0, Landroidx/appcompat/view/menu/b;->r:I

    invoke-virtual {v4, v1}, Landroidx/appcompat/widget/i2;->C(I)V
    ...
    invoke-virtual {v4, v7}, Landroidx/appcompat/widget/n2;->Q(Z)V

    invoke-virtual {v4, v5}, Landroidx/appcompat/widget/n2;->N(Ljava/lang/Object;)V
    ...
    invoke-virtual {v4, v6}, Landroidx/appcompat/widget/i2;->z(Landroid/view/View;)V
    ...
    :goto_6
    invoke-virtual {v4, v12}, Landroidx/appcompat/widget/i2;->l(I)V

    invoke-virtual {v4, v3}, Landroidx/appcompat/widget/i2;->I(Z)V

    invoke-virtual {v4, v8}, Landroidx/appcompat/widget/i2;->j(I)V
    ...
    invoke-virtual {v4, v2}, Landroidx/appcompat/widget/i2;->l(I)V
    ...
    invoke-virtual {v4, v2}, Landroidx/appcompat/widget/i2;->j(I)V
    ...
    invoke-virtual {v4, v2}, Landroidx/appcompat/widget/i2;->D(Landroid/graphics/Rect;)V
    ...
    invoke-direct {v2, v4, p1, v3}, Landroidx/appcompat/view/menu/b$d;-><init>(Landroidx/appcompat/widget/n2;Landroidx/appcompat/view/menu/e;I)V

    iget-object v3, p0, Landroidx/appcompat/view/menu/b;->m:Ljava/util/List;

    invoke-interface {v3, v2}, Ljava/util/List;->add(Ljava/lang/Object;)Z

    invoke-virtual {v4}, Landroidx/appcompat/widget/i2;->a()V

    invoke-virtual {v4}, Landroidx/appcompat/widget/i2;->g()Landroid/widget/ListView;
...
.method private z()Landroidx/appcompat/widget/n2;
    .locals 5
    ...
    invoke-direct {v0, v1, v4, v2, v3}, Landroidx/appcompat/widget/n2;-><init>(Landroid/content/Context;Landroid/util/AttributeSet;II)V

    iget-object v1, p0, Landroidx/appcompat/view/menu/b;->p:Landroidx/appcompat/widget/j2;

    invoke-virtual {v0, v1}, Landroidx/appcompat/widget/n2;->P(Landroidx/appcompat/widget/j2;)V

    invoke-virtual {v0, p0}, Landroidx/appcompat/widget/i2;->H(Landroid/widget/AdapterView$OnItemClickListener;)V

    invoke-virtual {v0, p0}, Landroidx/appcompat/widget/i2;->G(Landroid/widget/PopupWindow$OnDismissListener;)V

    iget-object v1, p0, Landroidx/appcompat/view/menu/b;->s:Landroid/view/View;

    invoke-virtual {v0, v1}, Landroidx/appcompat/widget/i2;->z(Landroid/view/View;)V

    iget v1, p0, Landroidx/appcompat/view/menu/b;->r:I

    invoke-virtual {v0, v1}, Landroidx/appcompat/widget/i2;->C(I)V
    ...
    invoke-virtual {v0, v1}, Landroidx/appcompat/widget/i2;->E(I)V
...
.method public b(Landroidx/appcompat/view/menu/e;Z)V
    ...
    iget-object v1, v0, Landroidx/appcompat/view/menu/b$d;->a:Landroidx/appcompat/widget/n2;

    invoke-virtual {v1, v2}, Landroidx/appcompat/widget/n2;->O(Ljava/lang/Object;)V

    iget-object v1, v0, Landroidx/appcompat/view/menu/b$d;->a:Landroidx/appcompat/widget/n2;

    invoke-virtual {v1, v3}, Landroidx/appcompat/widget/i2;->A(I)V

    :cond_2
    iget-object v0, v0, Landroidx/appcompat/view/menu/b$d;->a:Landroidx/appcompat/widget/n2;
...
.method public dismiss()V
    ...
    iget-object v3, v2, Landroidx/appcompat/view/menu/b$d;->a:Landroidx/appcompat/widget/n2;

    invoke-virtual {v3}, Landroidx/appcompat/widget/i2;->c()Z

    move-result v3

    if-eqz v3, :cond_0

    iget-object v2, v2, Landroidx/appcompat/view/menu/b$d;->a:Landroidx/appcompat/widget/n2;
...
.method public onDismiss()V
    ...
    iget-object v4, v3, Landroidx/appcompat/view/menu/b$d;->a:Landroidx/appcompat/widget/n2;

    invoke-virtual {v4}, Landroidx/appcompat/widget/i2;->c()Z
...
.method public p(Landroid/view/View;)V
    ...
    invoke-static {p1}, Landroidx/core/view/c1;->q(Landroid/view/View;)I

    move-result p1

    invoke-static {v0, p1}, Landroidx/core/view/v;->a(II)I
